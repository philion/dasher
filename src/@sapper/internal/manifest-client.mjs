...
export const components = [
	...
	{
		js: () => import("../../../routes/activity_log.svelte"),
...
if (typeof window !== 'undefined') {
	import("/home/philion/projects/sb-admin-svelte/node_modules/sapper/sapper-dev-client.js").then(client => {
